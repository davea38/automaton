---
name: automaton-reviewer
description: Verifies build output against specs and validation commands
model: opus
tools:
  - Read
  - Glob
...
109. The Agent tool spawns built-in subagents (Explore, Plan, general-purpose). If you are invoked as a subagent yourself, the Agent tool is unavailable — use Grep/Glob/Read directly instead.
