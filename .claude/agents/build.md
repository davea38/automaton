...
19. The Agent tool spawns built-in subagents (Explore, Plan, general-purpose). If you are invoked as a subagent yourself, the Agent tool is unavailable — use Grep/Glob/Read directly instead.
