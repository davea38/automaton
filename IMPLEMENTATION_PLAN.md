...
- [ ] Copy the root `PROMPT_build.md` to `templates/PROMPT_build.md` (WHY: template is missing self-build safety rules from spec-22 and context efficiency reads from spec-24)
